						...
						<div className="flex items-center justify-between">
							...
							{ alreadySaved ? (
								...
								<button type="button"
								        ...
								        className="bg-blue-500 opacity-70 hover:opacity-100 text-white font-bold px-5 py-1 text-base rounded-3xl hover:shadow-md outlined-none">
									Save
								</button>
							) }
						</div>
						<div className="flex justify-between items-center gap-2 w-full">
							...
							{ postedBy?._id === userInfo?.sub && (
								<button type="button"
								        ...
								        className="bg-red-500 p-2 opacity-70 hover:opacity-100 font-bold text-white rounded-3xl hover:shadow-md outlined-none">
									<AiTwotoneDelete/>
								</button>
							) }
						</div>

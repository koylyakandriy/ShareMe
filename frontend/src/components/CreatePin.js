...
const CreatePin = ({ user }) => {
	...
	const uploadImage = ({ target }) => {
		...
		if (type === 'image/jpg' || type === 'image/jpeg' || type === 'image/svg' || type === 'image/png' || type === 'image/gif' || type === 'image/tiff') {
			...
			client.assets
				.upload('image', target.files[0], { contentType: type, filename: name })
				.then(document => {
	...
	return (
		<div className="flex flex-col justify-content items-center mt-5 lg:h-4/5">
			...
			<div
				...
				<div className="bh-secondaryColor p-3 flex flex-0.7 w-full">
					<div
				...
				<div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
					...
					{ user && (
						<div
							className="flex gap-2 my-2 items-center items-center bg-white rounded-lg">
